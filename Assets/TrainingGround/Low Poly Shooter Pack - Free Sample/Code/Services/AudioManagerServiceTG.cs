...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    /// </summary>
    public class AudioManagerServiceTG : MonoBehaviour, IAudioManagerServiceTG
    {
        /// <summary>
        ...
        private readonly struct OneShotCoroutine
        {
            ...
            /// Audio Settings.
            /// </summary>
            public AudioSettingsTG Settings { get; }
            /// <summary>
            /// Delay.
            /// </summary>
            ...
            /// Constructor.
            /// </summary>
            public OneShotCoroutine(AudioClip clip, AudioSettingsTG settings, float delay)
            {
                //Clip.
                Clip = clip;
                //Settings
        ...
        /// </summary>
        private void PlayOneShot_Internal(AudioClip clip, AudioSettingsTG settings)
        {
        ...
        public void PlayOneShot(AudioClip clip, AudioSettingsTG settings = default)
        {
            //Play.
            PlayOneShot_Internal(clip, settings);
        }

        public void PlayOneShotDelayed(AudioClip clip, AudioSettingsTG settings = default, float delay = 1.0f)
        {
            //Play.
