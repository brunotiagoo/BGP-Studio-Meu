...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    /// </summary>
    public interface IAudioManagerServiceTG : IGameServiceTG
    {
        /// <summary>
        ...
        void PlayOneShot(AudioClip clip, AudioSettingsTG settings = default);
        ...
        void PlayOneShotDelayed(AudioClip clip, AudioSettingsTG settings = default, float delay = 1.0f);
    }
}