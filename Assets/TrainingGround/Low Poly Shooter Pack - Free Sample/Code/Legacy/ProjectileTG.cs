...
public class ProjectileTG : MonoBehaviour {
	...
	private void Start ()
	{
		...
		var gameModeService = ServiceLocatorTG.Current.Get<IGameModeServiceTG>();
	...
	private void OnCollisionEnter (Collision collision)
	{
		...
		if (collision.gameObject.GetComponent<ProjectileTG>() != null)
			return;
		...
		if (collision.transform.tag == "ExplosiveBarrel") 
		{
			...
			collision.transform.gameObject.GetComponent
				<ExplosiveBarrelScriptTG>().explode = true;
			//Destroy bullet object
			Destroy(gameObject);
		}
