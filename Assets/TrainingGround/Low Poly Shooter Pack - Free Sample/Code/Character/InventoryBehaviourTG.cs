...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    /// </summary>
    public abstract class InventoryBehaviourTG : MonoBehaviour
    {
        #region GETTERS
        ...
        /// </summary>
        public abstract WeaponBehaviourTG GetEquipped();
        ...
        public abstract WeaponBehaviourTG Equip(int index);
