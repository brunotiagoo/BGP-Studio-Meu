...
namespace InfimaGames.LowPolyShooterPack
{
	...
	/// </summary>
	[RequireComponent(typeof(CharacterKinematicsTG))]
	public sealed class CharacterTG : CharacterBehaviourTG
	{
		...
		[Tooltip("Inventory.")]
		[SerializeField]
		private InventoryBehaviourTG inventory;
		...
		/// </summary>
		private CharacterKinematicsTG characterKinematics;
		
		/// <summary>
		/// The currently equipped weapon.
		/// </summary>
		private WeaponBehaviourTG equippedWeapon;
		/// <summary>
		/// The equipped weapon's attachment manager.
		/// </summary>
		private WeaponAttachmentManagerBehaviourTG weaponAttachmentManager;
		
		/// <summary>
		/// The scope equipped on the character's weapon.
		/// </summary>
		private ScopeBehaviourTG equippedWeaponScope;
		/// <summary>
		/// The magazine equipped on the character's weapon.
		/// </summary>
		private MagazineBehaviourTG equippedWeaponMagazine;
		...
		protected override void Awake()
		{
			...
			characterKinematics = GetComponent<CharacterKinematicsTG>();
		...
		public override InventoryBehaviourTG GetInventory() => inventory;
