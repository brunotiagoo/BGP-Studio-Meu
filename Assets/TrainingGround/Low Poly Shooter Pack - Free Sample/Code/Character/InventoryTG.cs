...
{
    public class InventoryTG : InventoryBehaviourTG
    {
        #region FIELDS
        ...
        /// </summary>
        private WeaponBehaviourTG[] weapons;
        
        /// <summary>
        /// Currently equipped WeaponBehaviour.
        /// </summary>
        private WeaponBehaviourTG equipped;
        /// <summary>
        ...
        public override void Init(int equippedAtStart = 0)
        {
            ...
            weapons = GetComponentsInChildren<WeaponBehaviourTG>(true);
            
            //Disable all weapons. This makes it easier for us to only activate the one we need.
            foreach (WeaponBehaviourTG weapon in weapons)
        ...
        public override WeaponBehaviourTG Equip(int index)
        {
        ...
        public override WeaponBehaviourTG GetEquipped() => equipped;
